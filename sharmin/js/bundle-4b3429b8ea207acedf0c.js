...
_reactDom2.default.render(_react2.default.createElement(_route2.default, null), document.getElementById('g-root'));
...
var Greeter = function Greeter() {
    return _react2.default.createElement(
        'h3',
        null,
        'hello, this is sharmin!'
    );
};

var RouterContainer = function RouterContainer(props) {
    return _react2.default.createElement(Home, { children: props.children });
};
...
var Router = function Router() {
    return _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(_reactRouterDom.Route, { path: '/', component: Greeter })
    );
};
